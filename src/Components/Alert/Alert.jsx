export default function Alert({ currentTheme, icon, message,onclose }) {
    return (
      <div className={`fixed bottom-5 right-5 max-w-sm ${currentTheme === "LIGHT" ? "bg-gray-600" : "bg-gray-950"} rounded-lg flex items-center p-3 cursor-pointer`} onClick={onclose}>
